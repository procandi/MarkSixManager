...
Begin VB.Form frmOrderAddNewPart 
   BackColor       =   &H00808080&
   BorderStyle     =   1  '單線固定
   Caption         =   "產品價格變更"
   ClientHeight    =   10215
   ...
   ClientTop       =   840
   ClientWidth     =   9795
   Icon            =   "frmOrderAddNewPart.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   10215
   ScaleWidth      =   9795
   Begin VB.TextBox txtNote_Lotto 
      BeginProperty Font 
         Name            =   "新細明體"
         Size            =   12
         Charset         =   136
   ...
   Begin VB.TextBox txtCurrentCount_Lotto2K 
      ...
      Width           =   1455
   End
   Begin VB.TextBox txtBonusMoney_Lotto 
      BeginProperty Font 
         Name            =   "新細明體"
         Size            =   12
         Charset         =   136
      ...
      Width           =   3015
   End
   Begin VB.TextBox txtAddMoney_Lotto 
      BeginProperty Font 
         Name            =   "新細明體"
         Size            =   12
         Charset         =   136
   ...
   Begin Threed.SSPanel pnlBasic 
      ...
      Begin VB.TextBox txtCurrentCount_HKN2K 
         ...
         Width           =   1455
      End
      Begin VB.TextBox txtBonusMoney_HKN 
         BeginProperty Font 
            Name            =   "新細明體"
            Size            =   12
            Charset         =   136
         ...
         Width           =   3135
      End
      Begin VB.TextBox txtAddMoney_HKN 
         BeginProperty Font 
            Name            =   "新細明體"
            Size            =   12
            Charset         =   136
      ...
      Begin VB.TextBox txtNote_539 
         ...
         Width           =   7695
      End
      Begin VB.TextBox txtBonusMoney_539 
         BeginProperty Font 
            Name            =   "新細明體"
            Size            =   12
            Charset         =   136
         ...
         Width           =   3015
      End
      Begin VB.TextBox txtAddMoney_539 
         BeginProperty Font 
            Name            =   "新細明體"
            Size            =   12
            Charset         =   136
   ...
   End
End
Attribute VB_Name = "frmOrderAddNewPart"
...
'On Error GoTo errout:
    ...
    If txtCurrentCount_539Car.Text <> "" Then
        ...
        Adodc1.Recordset.Fields.Item("Note").Value = txtNote_539.Text
        ...
        End If
        Adodc1.Recordset.Fields.Item("AddMoney").Value = txtAddMoney_539.Text
        Adodc1.Recordset.Fields.Item("BonusMoney").Value = txtBonusMoney_539.Text
    ...
    If txtCurrentCount_HKNCar.Text <> "" Then
        Adodc1.Recordset.Fields.Item("CID").Value = basVariable.SelectCID
        Adodc1.Recordset.Fields.Item("CurrentDate").Value = txtCurrentDate.Text
        Adodc1.Recordset.Fields.Item("Note").Value = txtNote_HKN.Text
        ...
        End If
        Adodc1.Recordset.Fields.Item("AddMoney").Value = txtAddMoney_HKN.Text
        Adodc1.Recordset.Fields.Item("BonusMoney").Value = txtBonusMoney_HKN.Text
    ...
    If txtCurrentCount_LottoCar.Text <> "" Then
        Adodc1.Recordset.Fields.Item("CID").Value = basVariable.SelectCID
        Adodc1.Recordset.Fields.Item("CurrentDate").Value = txtCurrentDate.Text
        Adodc1.Recordset.Fields.Item("Note").Value = txtNote_Lotto.Text
        ...
        End If
        Adodc1.Recordset.Fields.Item("AddMoney").Value = txtAddMoney_Lotto.Text
        Adodc1.Recordset.Fields.Item("BonusMoney").Value = txtBonusMoney_Lotto.Text
    ...
    If flag Then
        ...
        txtAddMoney_539.Text = ""
        txtBonusMoney_539.Text = ""
        ...
        txtAddMoney_HKN.Text = ""
        txtBonusMoney_HKN.Text = ""
        ...
        txtAddMoney_Lotto.Text = ""
        txtBonusMoney_Lotto.Text = ""
...
Private Sub txtNote_539_KeyUp(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyReturn Then
        Call txtCurrentCount_HKNCar.SetFocus
    End If
End Sub
Private Sub txtNote_HKN_KeyUp(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyReturn Then
...
Private Sub txtWinningCount_539Package_KeyUp(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyReturn Then
        Call txtAddMoney_539.SetFocus
    End If
End Sub
Private Sub txtAddMoney_539_KeyUp(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyReturn Then
        Call txtBonusMoney_539.SetFocus
    End If
End Sub
Private Sub txtBonusMoney_539_KeyUp(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyReturn Then
        Call txtNote_539.SetFocus
    End If
End Sub
...
Private Sub txtWinningCount_HKNSpecial_KeyUp(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyReturn Then
        Call txtAddMoney_HKN.SetFocus
    End If
End Sub
Private Sub txtAddMoney_HKN_KeyUp(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyReturn Then
        Call txtBonusMoney_HKN.SetFocus
    End If
End Sub
Private Sub txtBonusMoney_HKN_KeyUp(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyReturn Then
        Call txtNote_HKN.SetFocus
    End If
End Sub
...
Private Sub txtWinningCount_LottoSpecial_KeyUp(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyReturn Then
        Call txtAddMoney_Lotto.SetFocus
    End If
End Sub
Private Sub txtAddMoney_Lotto_KeyUp(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyReturn Then
        Call txtBonusMoney_Lotto.SetFocus
    End If
End Sub
Private Sub txtBonusMoney_Lotto_KeyUp(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeyReturn Then
        Call txtNote_Lotto.SetFocus
    End If
End Sub
