...
Begin VB.Form frmConfirmCSV 
   ...
   End
End
Attribute VB_Name = "frmConfirmCSV"
...
Sub DayReport(ByVal TargetPath As String)
    ...
    Open TargetPath For Output As #1
        ...
        Do Until custom_rec.EOF
            ...
            For i = 0 To Count - 1
                ...
                Do Until rec1.EOF
                    ...
                    rec1.MoveNext
                Loop
                Body = Body & "<td>" & SimpleRound(CurrentCount, 4) & "</td>"
                Body = Body & "<td>" & SimpleRound(WinningCount, 4) & "</td>"
                ...
                End If
            Next
            Body = Body & "<td>" & SimpleRound(PriceCount, 0) & "</td>"
            Body = Body & "</tr>"
            Print #1, Body
        ...
        Body = Body & "<td>買數量</td>"
        For i = 0 To Count - 1
            Body = Body & "<td>" & SimpleRound(PIDBuyCurrentCount(i), 4) & "</td>"
            Body = Body & "<td>" & SimpleRound(PIDBuyWinningCount(i), 4) & "</td>"
        Next
        Body = Body & "</tr>"
        Print #1, Body
        Body = "<tr>"
        Body = Body & "<td>買金額</td>"
        For i = 0 To Count - 1
            Body = Body & "<td>" & SimpleRound(PIDBuyCurrentPrice(i), 0) & "</td>"
            Body = Body & "<td>" & SimpleRound(PIDBuyWinningPrice(i), 0) & "</td>"
        Next
        Body = Body & "</tr>"
        Print #1, Body
        ...
        Body = Body & "<td>賣數量</td>"
        For i = 0 To Count - 1
            Body = Body & "<td>" & SimpleRound(PIDSellCurrentCount(i), 4) & "</td>"
            Body = Body & "<td>" & SimpleRound(PIDSellWinningCount(i), 4) & "</td>"
        Next
        Body = Body & "</tr>"
        Print #1, Body
        Body = "<tr>"
        Body = Body & "<td>賣金額</td>"
        For i = 0 To Count - 1
            Body = Body & "<td>" & SimpleRound(PIDSellCurrentPrice(i), 0) & "</td>"
            Body = Body & "<td>" & SimpleRound(PIDSellWinningPrice(i), 0) & "</td>"
        Next
        Body = Body & "</tr>"
        Print #1, Body
        ...
        Body = "<tr>"
        Body = Body & "<td>小計買</td>"
        Body = Body & "<td>" & SimpleRound(BuyCurrentCount, 4) & "</td><td></td>"
        Body = Body & "<td>金額</td>"
        Body = Body & "<td>" & SimpleRound(BuyCurrentPrice, 0) & "</td><td></td>"
        Body = Body & "</tr>"
        Print #1, Body
        Body = "<tr>"
        Body = Body & "<td>小計買中</td>"
        Body = Body & "<td>" & SimpleRound(BuyWinningCount, 4) & "</td><td></td>"
        Body = Body & "<td>金額</td>"
        Body = Body & "<td>" & SimpleRound(BuyWinningPrice, 0) & "</td><td></td>"
        Body = Body & "</tr>"
        Print #1, Body
        Body = "<tr>"
        Body = Body & "<td>小計賣</td>"
        Body = Body & "<td>" & SimpleRound(SellCurrentCount, 4) & "</td><td></td>"
        Body = Body & "<td>金額</td>"
        Body = Body & "<td>" & SimpleRound(SellCurrentPrice, 0) & "</td><td></td>"
        Body = Body & "</tr>"
        Print #1, Body
        Body = "<tr>"
        Body = Body & "<td>小計賣中</td>"
        Body = Body & "<td>" & SimpleRound(SellWinningCount, 4) & "</td><td></td>"
        Body = Body & "<td>金額</td>"
        Body = Body & "<td>" & SimpleRound(SellWinningPrice, 0) & "</td><td></td>"
        Body = Body & "</tr>"
        Print #1, Body
    ...
    Open TargetPath For Output As #1
        ...
        Do Until custom_rec.EOF
            ...
            For i = 0 To Count - 1
                ...
                Loop
                Body = Body & "<td>" & SimpleRound(CurrentCount, 4) & "</td>"
                Body = Body & "<td>" & SimpleRound(CurrentPrice, 0) & "</td>"
            ...
            Do Until rec1.EOF
                ...
                Body = Body & "<td>來自" & rec1.Fields.Item("CName") & "成數" & Proportion & "%共" & SimpleRound(BonusMoney * (Proportion / 100), 0) & "元。</td>"
                rec1.MoveNext
            Loop
    ...
    Open TargetPath For Output As #1
        ...
        Do Until custom_rec.EOF
            ...
            For i = 0 To Count - 1
                ...
                Body = Body & "<td>" & SimpleRound(CurrentPrice, 0) & "</td>"
                Body = Body & "<td>" & SimpleRound(WinningCount, 4) & "</td>"
                Body = Body & "<td>" & SimpleRound(WinningPrice, 0) & "</td>"
        ...
        Body = "<tr><td>數量總計</td>"
        For i = 0 To Count - 1
            Body = Body & "<td>" & SimpleRound(CurrentCountAll(i), 4) & "</td><td></td>"
            Body = Body & "<td>" & SimpleRound(WinningCountAll(i), 4) & "</td><td></td>"
        Next
        Body = Body & "</tr>"
        Print #1, Body
        ...
        Do Until custom_rec.EOF
            ...
            For i = 6 To 0 Step -1
                If SaveOrderDate(n) = Format(DateTime.DateAdd("d", -i, txtCurrentDate.Text), "yyyy/MM/dd") Then
                    ...
                    Body = Body & "<td>" & SimpleRound(CurrentPriceCount(n), 0) & "</td>"
                    'Body = Body & "<td>" & SimpleRound(WinningPriceCount(n) ,0) & "</td>"
                ...
                End If
            Next
            Body = Body & "<td>" & SimpleRound(PriceCount, 0) & "</td></tr>"
            Print #1, Body
